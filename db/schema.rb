...
ActiveRecord::Schema[7.0].define(version: 2024_07_02_183913) do
  ...
  create_table "order_invitations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["filament_id"], name: "index_order_invitations_on_filament_id"
  ...
  create_table "profiles_filaments", id: false, force: :cascade do |t|
    t.bigint "profile_id", null: false
    t.bigint "filament_id", null: false
    t.index ["filament_id"], name: "index_profiles_filaments_on_filament_id"
    t.index ["profile_id"], name: "index_profiles_filaments_on_profile_id"
  end
  ...
  add_foreign_key "order_invitations", "filaments"
  ...
  add_foreign_key "profiles_filaments", "filaments"
  add_foreign_key "profiles_filaments", "profiles"
